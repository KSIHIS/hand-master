...
class Annotator:
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if prefix in prefix_mapping:
            label = prefix_mapping[prefix]
        else:
            label = ''  # 如果前缀不在映射中，转化为 ''

        print('nihaopya' + label)
    ...
    #         'V': '右转',
    #         'I': '鸣笛',
    #         'I love you': '',  # 假设这个字符串不对应任何指令
    #         'number 7': '',  # 同样，这个字符串也不对应任何指令
    #         'D': '',  # 以此类推...
    #         'W': '',
    #         'D': '',
    #     }
    #     # 尝试从转换规则中获取对应的值，如果没有找到则返回空字符串
    #     return conversion_rules.get(label, '')
